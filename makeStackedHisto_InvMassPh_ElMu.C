...
void makeStackedHisto_InvMassPh_ElMu(){
...
TH1F *hSS = (TH1F*)fileSS->Get("h_InvariantMass_Ph_ElMu");
hSS->Rebin(300);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_InvariantMass_Ph_ElMu");
h_Signal->Rebin(300);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_InvariantMass_Ph_ElMu");
h_Signal_Stop->Rebin(300);
...
TLegend *leg1 = new TLegend(0.64,0.47,0.90,0.90,NULL,"brNDC"); 
...
TBox *blot=new TBox(0, -0.5, 100, 3);
