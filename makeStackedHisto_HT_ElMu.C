...
TH1F *hSS = (TH1F*)fileSS->Get("h_HT_ElMu");
hSS->Rebin(40);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_HT_ElMu");
h_Signal_Stop->Rebin(40);
...
gStyle->SetHatchesLineWidth(4);
gStyle->SetErrorX(0.5);
h_ratio_Unc->GetXaxis()->SetRangeUser(0.0, 500.0);
