#include "ReadLowPtSUSY_Tree_ComparisonDataMC_FixingNuances_Muonia.h"

int ReadLowPtSUSY_Tree_ComparisonDataMC_FixingNuances_Muonia(std::string infile, std::string outfile, std::string type, std::string signSelection, std::string MCSample){
  ...
  Bool_t          fired_HLT_IsoMu24;
  Bool_t          fired_HLT_Mu13_Mu8;
  Bool_t          fired_HLT_Mu17_Mu8;
  Bool_t          fired_HLT_Mu17_TkMu8;
  Bool_t          fired_HLT_Mu22_TkMu8;
  Bool_t          fired_HLT_Mu22_TkMu22;
  Bool_t          fired_HLT_Dimuon0_Jpsi_Muon;
  Bool_t          fired_HLT_Dimuon0_Upsilon_Muon;
  Bool_t          fired_HLT_Dimuon11_Upsilon;
  Bool_t          fired_HLT_Dimuon7_Upsilon;
  Bool_t          fired_HLT_DoubleMu3_4_Dimuon5_Bs_Central;
  Bool_t          fired_HLT_DoubleMu3p5_4_Dimuon5_Bs_Central;
  Bool_t          fired_HLT_DoubleMu4_Dimuon7_Bs_Forward;
  Bool_t          fired_HLT_DoubleMu4_JpsiTk_Displaced;
  Bool_t          fired_HLT_DoubleMu4_Jpsi_Displaced;
  Bool_t          fired_HLT_Mu5_Track2_Jpsi;
  Bool_t          fired_HLT_Mu5_Track3p5_Jpsi;
  Bool_t          fired_HLT_Mu7_Track7_Jpsi;
  Bool_t          fired_HLT_Tau2Mu_ItTrack;
  Bool_t          fired_HLT_Dimuon10_Jpsi;
  Bool_t          fired_HLT_Dimuon5_PsiPrime;
  Bool_t          fired_HLT_Dimuon5_Upsilon;
  Bool_t          fired_HLT_Dimuon7_PsiPrime;
  Bool_t          fired_HLT_Dimuon8_Jpsi;
  Bool_t          fired_HLT_Dimuon8_Upsilon;
  Bool_t          fired_HLT_DoubleMu3p5_LowMassNonResonant_Displaced;
  Bool_t          fired_HLT_DoubleMu3p5_LowMass_Displaced;
  Bool_t          fired_HLT_Mu15_TkMu5_Onia;
  Bool_t          fired_HLT_Mu22_Photon22_CaloIdL;
  ...
  tree->SetBranchAddress("ph_px", &(ph_px));
  tree->SetBranchAddress("ph_py", &(ph_py));
  tree->SetBranchAddress("ph_pz", &(ph_pz));
  ...
  if(type=="Data"){
    ...
    tree->SetBranchAddress("fired_HLT_IsoMu24", &(fired_HLT_IsoMu24));
    tree->SetBranchAddress("fired_HLT_Mu13_Mu8", &(fired_HLT_Mu13_Mu8));
    tree->SetBranchAddress("fired_HLT_Mu17_Mu8", &(fired_HLT_Mu17_Mu8));
    tree->SetBranchAddress("fired_HLT_Mu17_TkMu8", &(fired_HLT_Mu17_TkMu8));
    tree->SetBranchAddress("fired_HLT_Mu22_TkMu8", &(fired_HLT_Mu22_TkMu8));
    tree->SetBranchAddress("fired_HLT_Mu22_TkMu22", &(fired_HLT_Mu22_TkMu22));
    tree->SetBranchAddress("fired_HLT_Dimuon0_Jpsi_Muon", &(fired_HLT_Dimuon0_Jpsi_Muon));
    tree->SetBranchAddress("fired_HLT_Dimuon0_Upsilon_Muon", &(fired_HLT_Dimuon0_Upsilon_Muon));
    tree->SetBranchAddress("fired_HLT_Dimuon11_Upsilon", &(fired_HLT_Dimuon11_Upsilon));
    tree->SetBranchAddress("fired_HLT_Dimuon7_Upsilon", &(fired_HLT_Dimuon7_Upsilon));
    tree->SetBranchAddress("fired_HLT_DoubleMu3_4_Dimuon5_Bs_Central", &(fired_HLT_DoubleMu3_4_Dimuon5_Bs_Central));
    tree->SetBranchAddress("fired_HLT_DoubleMu3p5_4_Dimuon5_Bs_Central", &(fired_HLT_DoubleMu3p5_4_Dimuon5_Bs_Central));
    tree->SetBranchAddress("fired_HLT_DoubleMu4_Dimuon7_Bs_Forward", &(fired_HLT_DoubleMu4_Dimuon7_Bs_Forward));
    tree->SetBranchAddress("fired_HLT_DoubleMu4_JpsiTk_Displaced", &(fired_HLT_DoubleMu4_JpsiTk_Displaced));
    tree->SetBranchAddress("fired_HLT_DoubleMu4_Jpsi_Displaced", &(fired_HLT_DoubleMu4_Jpsi_Displaced));
    tree->SetBranchAddress("fired_HLT_Mu5_Track2_Jpsi", &(fired_HLT_Mu5_Track2_Jpsi));
    tree->SetBranchAddress("fired_HLT_Mu5_Track3p5_Jpsi", &(fired_HLT_Mu5_Track3p5_Jpsi));
    tree->SetBranchAddress("fired_HLT_Mu7_Track7_Jpsi", &(fired_HLT_Mu7_Track7_Jpsi));
    tree->SetBranchAddress("fired_HLT_Tau2Mu_ItTrack", &(fired_HLT_Tau2Mu_ItTrack));
    tree->SetBranchAddress("fired_HLT_Dimuon10_Jpsi", &(fired_HLT_Dimuon10_Jpsi));
    tree->SetBranchAddress("fired_HLT_Dimuon5_PsiPrime", &(fired_HLT_Dimuon5_PsiPrime));
    tree->SetBranchAddress("fired_HLT_Dimuon5_Upsilon", &(fired_HLT_Dimuon5_Upsilon));
    tree->SetBranchAddress("fired_HLT_Dimuon7_PsiPrime", &(fired_HLT_Dimuon7_PsiPrime));
    tree->SetBranchAddress("fired_HLT_Dimuon8_Jpsi", &(fired_HLT_Dimuon8_Jpsi));
    tree->SetBranchAddress("fired_HLT_Dimuon8_Upsilon", &(fired_HLT_Dimuon8_Upsilon));
    tree->SetBranchAddress("fired_HLT_DoubleMu3p5_LowMassNonResonant_Displaced", &(fired_HLT_DoubleMu3p5_LowMassNonResonant_Displaced));
    tree->SetBranchAddress("fired_HLT_DoubleMu3p5_LowMass_Displaced", &(fired_HLT_DoubleMu3p5_LowMass_Displaced));
    tree->SetBranchAddress("fired_HLT_Mu15_TkMu5_Onia", &(fired_HLT_Mu15_TkMu5_Onia));
    tree->SetBranchAddress("fired_HLT_Mu22_Photon22_CaloIdL", &(fired_HLT_Mu22_Photon22_CaloIdL));
  ...
  int nEvents_DimuonBeforeTrigger = 0.0;
  ...
  for (int i=0; i<nEvents; ++i)
    {
     ...
     if(type=="Data")
       {
       if(fired_HLT_Dimuon0_Jpsi_Muon!=1 and fired_HLT_Dimuon0_Upsilon_Muon!=1 and fired_HLT_Dimuon11_Upsilon!=1 and fired_HLT_Dimuon7_Upsilon!=1 and fired_HLT_Mu5_Track2_Jpsi!=1 and fired_HLT_Mu5_Track3p5_Jpsi!=1 and fired_HLT_Mu7_Track7_Jpsi!=1 and fired_HLT_Tau2Mu_ItTrack!=1) continue;        
       //if(fired_HLT_Mu17_Mu8!=1 and fired_HLT_Mu17_TkMu8!=1 and fired_HLT_Mu22_TkMu8!=1 and fired_HLT_Mu22_TkMu22!=1) continue; //Dimuon Triggers 
       }
     nEvents_Incoming++; 
/*
     if(type=="MC")
...
*/
     ...
     for (unsigned int j=0; j<ph_pt->size(); ++j)
       ...
       photon.px=ph_px->at(j);
       photon.py=ph_py->at(j);
       photon.pz=ph_pz->at(j);
   ...
   for(unsigned int k=0; k<photons.size(); ++k)
   {
    ...
    {
       Photon.SetPxPyPzE(photons.at(k).px, photons.at(k).py, photons.at(k).pz, photons.at(k).energy);
...
// Now sorting this vector of structs
   ...
   for(unsigned int l=0; l<photons.size(); ++l)
     {
       ...
       //if(fabs(photons.at(l).eta)<1.444 and photons.at(l).pT>30.0 and photons.at(l).isLoose==1 and photons.at(l).phIsoLoose==1 and photons.at(l).phpixelVeto==0){// and photons.at(l).phSigmaIetaIeta > 0.001 and photons.at(l).phSigmaIphiIphi>0.0001 and swissCross.at(l)<0.90){ //photons.at(l).phSigmaIphiIphi>0.0001 and swissCross.at(l)<0.90){
         {
         Photon.SetPxPyPzE(photons.at(l).px, photons.at(l).py, photons.at(l).pz, photons.at(l).energy);
  ...
  if(Muons.size()==2) nEvents_DimuonBeforeTrigger++;
  //Preliminary event cuts guided by the trigger:
  if (not(Photon_vector.size() > 0 and Photon_vector.at(0).Pt() > 20.0)) continue; //for greg special case. change to correct numbers // and caloMET > 35.0)) continue;
  nEvents_Trigger++;
  ...
  if(eventWeight > 0.0 and Muons.size()==2){ 
      ...
      if(signSelection=="OS" and (Muons.at(0).Charge*Muons.at(1).Charge)==-1){
        ...
        if((Muons.at(0).LepLV+Muons.at(1).LepLV).M() > 3.0 and (Muons.at(0).LepLV+Muons.at(1).LepLV).M() < 3.2){
 ...
 //ElMu channel
  ...
  cout << "nEvents_DimuonBeforeTrigger = " << nEvents_DimuonBeforeTrigger << endl;
