#include "ReadLowPtSUSY_Tree_ControlRegion_FakePhoton.h"

int ReadLowPtSUSY_Tree_ControlRegion_FakePhoton(std::string infile,  std::string outfile, std::string type){
