...
void makeStackedHisto_h_el_leading_pt_ElMu(){
...
THStack hs("hs","Leading electron p_{T} [GeV]");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_el_pt_leading_ElMu");
hSS->Rebin(20);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_el_pt_leading_ElMu");
...
h_ratio->SetTitle("; #bf{Leading electron p_{T} (GeV)}; Data/MC Ratio");
