...
void makeStackedHisto_caloMET_ElMu(){
...
TH1F *hSS = (TH1F*)fileSS->Get("h_caloMET_ElMu");
hSS->Rebin(20);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_caloMET_ElMu");
h_Signal->Rebin(20);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_caloMET_ElMu");
...
h_ratio_Unc->GetXaxis()->SetRangeUser(35, 300.0);
