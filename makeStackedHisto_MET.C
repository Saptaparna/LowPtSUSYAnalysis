...
h0->Rebin(10);
h0->GetXaxis()->SetRangeUser(0, 250);
...
TH1F *hSS = (TH1F*)fileSS->Get("h_MET_MuMu");
hSS->Rebin(10);
hSS->GetXaxis()->SetRangeUser(0, 250);
...
h1a->Rebin(10);
h1a->GetXaxis()->SetRangeUser(0, 250);
...
h5->Rebin(10);
h5->GetXaxis()->SetRangeUser(0, 250);
h5->Scale(T_tW_SF);
...
h6->Rebin(10);
h6->GetXaxis()->SetRangeUser(0, 250);
h6->Scale(Tbar_tW_SF);
...
h8->Rebin(10);
h8->GetXaxis()->SetRangeUser(0, 250);
h8->Scale(WZ_SF);
...
h9->Rebin(10);
h9->GetXaxis()->SetRangeUser(0, 250);
h9->Scale(WWG_SF);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_MET_MuMu");
h_Signal->Rebin(10);
h_Signal->GetXaxis()->SetRangeUser(0, 250);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_MET_MuMu");
h_Signal_Stop->Rebin(10);
h_Signal_Stop->GetXaxis()->SetRangeUser(0, 250);
...
h_ratio->GetXaxis()->SetRangeUser(0, 250); 
h_ratio->Draw();
...
h_ratio_Unc->GetXaxis()->SetRangeUser(0, 200.0);
