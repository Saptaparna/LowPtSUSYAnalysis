#include "ReadLowPtSUSY_Tree_ComparisonDataMC_LWP.h"

int ReadLowPtSUSY_Tree_ComparisonDataMC_LWP(std::string infile, std::string outfile, std::string type, std::string signSelection, std::string MCSample){
