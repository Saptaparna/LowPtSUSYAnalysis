...
THStack hs("hs","3-Body Invariant Mass [GeV]");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_InvariantMass_Ph_MuMu");
hSS->Rebin(200);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_InvariantMass_Ph_MuMu");
...
TLegend *leg1 = new TLegend(0.63,0.47,0.90,0.90,NULL,"brNDC"); 
