...
TH1F *hSS = (TH1F*)fileSS->Get("h_caloMET_MuMu");
hSS->Rebin(20);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_caloMET_MuMu");
h_Signal->Rebin(20);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_caloMET_MuMu");
...
h_ratio->SetTitle("; #bf{Offline caloMET (GeV)}; Data/MC Ratio");
