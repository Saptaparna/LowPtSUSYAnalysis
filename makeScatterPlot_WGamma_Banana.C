...
void makeScatterPlot_WGamma_Banana(std::string infile){
...
leg1->AddEntry(h2,"e#gamma MET","p");
leg1->Draw();

c1->SaveAs((infile+"_WGamma_Banana.pdf").c_str());
c1->SaveAs((infile+"_WGamma_Banana.png").c_str());
