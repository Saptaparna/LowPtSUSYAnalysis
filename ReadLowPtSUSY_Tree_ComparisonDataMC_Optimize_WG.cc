#include "ReadLowPtSUSY_Tree_ComparisonDataMC_Optimize_WG.h"

int ReadLowPtSUSY_Tree_ComparisonDataMC_Optimize_WG(std::string infile, std::string outfile, std::string type, std::string signSelection, std::string MCSample){
