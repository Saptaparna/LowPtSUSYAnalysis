...
typedef struct
{
  ...
  float energy;
  float sigmaIetaIeta;
  float phMatchedisTightWS;
  float phMatchedIsoTight;
  float phMatchedpixelVeto; 
} MatchedPhotonInfo;
...
bool sortPhotonVectorsInDescendingpT(AnalysisPhotonInfo pho1, AnalysisPhotonInfo pho2)
{
  return (pho1.PhLV.Pt() > pho2.PhLV.Pt());
}
...
bool sortMatchedPhotonsInDescendingpT(MatchedPhotonInfo mpho1, MatchedPhotonInfo mpho2)
{
  return (mpho1.pT > mpho2.pT);
}
