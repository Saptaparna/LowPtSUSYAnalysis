...
hs.SetMaximum(70.0);
hs.SetMinimum(1.0);
hs.GetXaxis()->SetRangeUser(50, 120);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_InvariantMass_Mu");
h_Data->Rebin(50);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(50, 120);
h_Data->Draw("SAME E");
...
c1.SaveAs("h_InvariantMass_Mu_Stacked.pdf");
c1.SaveAs("h_InvariantMass_Mu_Stacked.png");
}
