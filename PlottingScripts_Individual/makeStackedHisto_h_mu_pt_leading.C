...
void makeStackedHisto_h_mu_pt_leading(){
...
TH1F *h1 = (TH1F*)file1->Get("h_mu_pt_leading");
h1->Rebin(10);
...
TH1F *h2 = (TH1F*)file2->Get("h_mu_pt_leading");
h2->Rebin(10);
...
TH1F *h3 = (TH1F*)file3->Get("h_mu_pt_leading");
h3->Rebin(10);
...
TH1F *h4 = (TH1F*)file4->Get("h_mu_pt_leading");
h4->Rebin(10);
...
TH1F *h5 = (TH1F*)file5->Get("h_mu_pt_leading");
h5->Rebin(10);
...
TH1F *h6 = (TH1F*)file6->Get("h_mu_pt_leading");
h6->Rebin(10);
...
TH1F *h7 = (TH1F*)file7->Get("h_mu_pt_leading");
h7->Rebin(10);
...
TH1F *h8 = (TH1F*)file8->Get("h_mu_pt_leading");
h8->Rebin(10);
...
TH1F *h9 = (TH1F*)file9->Get("h_mu_pt_leading");
h9->Rebin(10);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_mu_pt_leading");
h_Data->Rebin(10);
...
c1.SaveAs("h_mu_pt_leading_Stacked.pdf");
c1.SaveAs("h_mu_pt_leading_Stacked.png");
}
