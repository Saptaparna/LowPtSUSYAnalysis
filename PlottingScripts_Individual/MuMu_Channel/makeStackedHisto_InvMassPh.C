...
TH1F *h1 = (TH1F*)file1->Get("h_InvariantMass_MuMuPh");
h1->Rebin(100);
...
TH1F *h1a = (TH1F*)file1a->Get("h_InvariantMass_MuMuPh");
h1a->Rebin(100);
...
TH1F *h2 = (TH1F*)file2->Get("h_InvariantMass_MuMuPh");
h2->Rebin(100);
...
TH1F *h3 = (TH1F*)file3->Get("h_InvariantMass_MuMuPh");
h3->Rebin(100);
...
TH1F *h4 = (TH1F*)file4->Get("h_InvariantMass_MuMuPh");
h4->Rebin(100);
...
TH1F *h5 = (TH1F*)file5->Get("h_InvariantMass_MuMuPh");
h5->Rebin(100);
...
TH1F *h6 = (TH1F*)file6->Get("h_InvariantMass_MuMuPh");
h6->Rebin(100);
...
TH1F *h8 = (TH1F*)file8->Get("h_InvariantMass_MuMuPh");
h8->Rebin(100);
...
TH1F *h9 = (TH1F*)file9->Get("h_InvariantMass_MuMuPh");
h9->Rebin(100);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_InvariantMass_MuMuPh");
h_Data->Rebin(100);
...
c1.SaveAs("h_InvariantMass_MuMuPh_Stacked.pdf");
c1.SaveAs("h_InvariantMass_MuMuPh_Stacked.png");
}
