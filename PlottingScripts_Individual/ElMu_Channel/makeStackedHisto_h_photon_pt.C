...
double signal_SF = (20*(7.4)*3)/100000;
...
TH1F *h1 = (TH1F*)file1->Get("h_photon_pt");
h1->Rebin(10);
...
TH1F *h1a = (TH1F*)file1a->Get("h_photon_pt");
h1a->Rebin(10);
...
TH1F *h2 = (TH1F*)file2->Get("h_photon_pt");
h2->Rebin(10);
...
TH1F *h3 = (TH1F*)file3->Get("h_photon_pt");
h3->Rebin(10);
...
TH1F *h4 = (TH1F*)file4->Get("h_photon_pt");
h4->Rebin(10);
...
TH1F *h5 = (TH1F*)file5->Get("h_photon_pt");
h5->Rebin(10);
...
TH1F *h6 = (TH1F*)file6->Get("h_photon_pt");
h6->Rebin(10);
...
TH1F *h8 = (TH1F*)file8->Get("h_photon_pt");
h8->Rebin(10);
...
TH1F *h9 = (TH1F*)file9->Get("h_photon_pt");
h9->Rebin(10);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_photon_pt");
h_Data->Rebin(10);
...
c1.SaveAs("h_photon_pt_Stacked.pdf");
c1.SaveAs("h_photon_pt_Stacked.png");
}
