...
h2->Rebin(10);
h2->GetXaxis()->SetRangeUser(25, 300);
h2->Scale(TTG_SF);
...
h3->Rebin(10);
h3->GetXaxis()->SetRangeUser(25, 300);
h3->Scale(WGSMu_SF);
...
h4->Rebin(10);
h4->GetXaxis()->SetRangeUser(25, 300);
h4->Scale(ZZ_SF);
...
hs.SetMaximum(8.0);
hs.SetMinimum(0.01);
hs.GetXaxis()->SetRangeUser(25, 300);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_HT");
h_Data->Rebin(10);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(25, 300);
h_Data->Draw("SAME E");
...
h_Signal->Rebin(10);
h_Signal->GetXaxis()->SetRangeUser(25, 300);
