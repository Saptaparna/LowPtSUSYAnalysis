...
double signal_SF = (20*(7.4)*2)/100000;

THStack hs("hs","Leading electron pT [GeV]");

TFile* file1 = TFile::Open("MC_ElMu/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_All_MuMu.root");
TH1F *h1 = (TH1F*)file1->Get("h_el_pt_leading_ElMu");
h1->Rebin(50);
h1->GetXaxis()->SetRangeUser(10, 300);
h1->Scale(ZGammaLL_SF);
h1->SetFillColor(kRed);
hs.Add(h1);

TFile* file1a = TFile::Open("MC_ElMu/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_All_TauTau.root");
TH1F *h1a = (TH1F*)file1a->Get("h_el_pt_leading_ElMu");
h1a->Rebin(50);
h1a->GetXaxis()->SetRangeUser(10, 300);
h1a->Scale(ZGammaLL_SF);
h1a->SetFillColor(kYellow);
hs.Add(h1a);

TFile* file2 = TFile::Open("MC_ElMu/Output_LowPtSUSY_Tree_TTGJets_8TeV_madgraph_CaloMET_All.root");
TH1F *h2 = (TH1F*)file2->Get("h_el_pt_leading_ElMu");
h2->Rebin(50);
h2->GetXaxis()->SetRangeUser(10, 300);
h2->Scale(TTG_SF);
h2->SetFillColor(kCyan);
hs.Add(h2);

TFile* file3 = new TFile("MC_ElMu/Output_LowPtSUSY_Tree_WGstarToLNu2Mu_TuneZ2star_CaloMET_All.root");
TH1F *h3 = (TH1F*)file3->Get("h_el_pt_leading_ElMu");
h3->Rebin(50);
h3->GetXaxis()->SetRangeUser(10, 300);
h3->Scale(WGSMu_SF);
h3->SetFillColor(kOrange);
hs.Add(h3);

TFile* file4 = new TFile("MC_ElMu/Output_LowPtSUSY_Tree_ZZJetsTo4L_TuneZ2star_CaloMET_All.root");
TH1F *h4 = (TH1F*)file4->Get("h_el_pt_leading_ElMu");
h4->Rebin(50);
h4->GetXaxis()->SetRangeUser(10, 300);
h4->Scale(ZZ_SF);
h4->SetFillColor(kGreen);
hs.Add(h4);

TFile* file5 = new TFile("MC_ElMu/Output_LowPtSUSY_Tree_T_tW_CaloMET_All.root");
TH1F *h5 = (TH1F*)file5->Get("h_el_pt_leading_ElMu");
h5->Rebin(50);
h5->GetXaxis()->SetRangeUser(10, 300);
h5->Scale(T_tW_SF);
h5->SetFillColor(kGray);
hs.Add(h5);

TFile* file6 = new TFile("MC_ElMu/Output_LowPtSUSY_Tree_Tbar_tW_CaloMET_All.root");
TH1F *h6 = (TH1F*)file6->Get("h_el_pt_leading_ElMu");
h6->Rebin(50);
h6->GetXaxis()->SetRangeUser(10, 300);
h6->Scale(Tbar_tW_SF);
h6->SetFillColor(kGray);
hs.Add(h6);

TFile* file8 = new TFile("MC_ElMu/Output_LowPtSUSY_Tree_WZJetsTo3LNu_CaloMET_All.root");
TH1F *h8 = (TH1F*)file8->Get("h_el_pt_leading_ElMu");
h8->Rebin(50);
h8->GetXaxis()->SetRangeUser(10, 300);
h8->Scale(WZ_SF);
h8->SetFillColor(kViolet+1);
hs.Add(h8);

TFile* file9 = new TFile("MC_ElMu/Output_LowPtSUSY_Tree_WWGJets_8TeV_madgraph_CaloMET_All.root");
TH1F *h9 = (TH1F*)file9->Get("h_el_pt_leading_ElMu");
h9->Rebin(50);
h9->GetXaxis()->SetRangeUser(10, 300);
h9->Scale(WWG_SF);
...
hs.SetMaximum(60.0);
hs.SetMinimum(0.01);
hs.GetXaxis()->SetRangeUser(10, 300);
hs.GetXaxis()->SetTitle("Leading electron pT [GeV]");
hs.GetXaxis()->SetLabelSize(0.02);
hs.GetXaxis()->SetTitleSize(0.02);

TFile* file_Data = new TFile("Data_ElMu/Output_LowPtSUSY_Tree_SinglePhotonParked_Run2012D_22Jan2013_All.root");
TH1F *h_Data = (TH1F*)file_Data->Get("h_el_pt_leading_ElMu");
h_Data->Rebin(50);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(10, 300);
h_Data->Draw("SAME E");
...
h_Signal->Rebin(50);
h_Signal->GetXaxis()->SetRangeUser(10, 300);
