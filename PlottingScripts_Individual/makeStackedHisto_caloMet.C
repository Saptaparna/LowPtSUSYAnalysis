...
TH1F *h2 = (TH1F*)file2->Get("h_caloMet");
h2->Rebin(10);
...
TH1F *h3 = (TH1F*)file3->Get("h_caloMet");
h3->Rebin(10);
...
TH1F *h4 = (TH1F*)file4->Get("h_caloMet");
h4->Rebin(10);
...
TH1F *h5 = (TH1F*)file5->Get("h_caloMet");
h5->Rebin(10);
...
TH1F *h6 = (TH1F*)file6->Get("h_caloMet");
h6->Rebin(10);
...
TH1F *h7 = (TH1F*)file7->Get("h_caloMet");
h7->Rebin(10);
...
TH1F *h8 = (TH1F*)file8->Get("h_caloMet");
h8->Rebin(10);
...
TH1F *h9 = (TH1F*)file9->Get("h_caloMet");
h9->Rebin(10);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_caloMet");
h_Data->Rebin(10);
...
c1.SaveAs("h_PFcaloMet_Stacked.pdf");
c1.SaveAs("h_PFcaloMet_Stacked.png");
}
