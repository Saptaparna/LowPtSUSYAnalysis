...
void makeStackedHisto_h_DeltaPhi_ph_mu2(){
...
TH1F *h2 = (TH1F*)file2->Get("h_DeltaPhi_ph_mu2");
h2->Rebin(100);
...
TH1F *h7 = (TH1F*)file7->Get("h_DeltaPhi_ph_mu2");
h7->Rebin(100);
...
TH1F *h8 = (TH1F*)file8->Get("h_DeltaPhi_ph_mu2");
h8->Rebin(100);
...
TH1F *h9 = (TH1F*)file9->Get("h_DeltaPhi_ph_mu2");
h9->Rebin(100);
...
hs.GetXaxis()->SetTitle("#DeltaR(Trailing Muon, #gamma)");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_DeltaPhi_ph_mu2");
h_Data->Rebin(100);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(0, 3.5);
h_Data->Draw("SAME E");

TLegend *leg1 = new TLegend(0.15,0.60,0.50,0.90,NULL,"brNDC"); 
...
h_ratio->SetTitle("; #DeltaR(Trailing Muon, #gamma); Data/MC Ratio");
...
c1.SaveAs("h_DeltaPhi_ph_mu2_Stacked.pdf");
c1.SaveAs("h_DeltaPhi_ph_mu2_Stacked.png");
}
