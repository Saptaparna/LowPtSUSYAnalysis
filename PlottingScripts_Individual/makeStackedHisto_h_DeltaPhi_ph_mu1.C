...
void makeStackedHisto_h_DeltaPhi_ph_mu1(){
...
TH1F *h2 = (TH1F*)file2->Get("h_DeltaPhi_ph_mu1");
h2->Rebin(100);
...
TH1F *h3 = (TH1F*)file3->Get("h_DeltaPhi_ph_mu1");
h3->Rebin(100);
...
TH1F *h4 = (TH1F*)file4->Get("h_DeltaPhi_ph_mu1");
h4->Rebin(100);
...
TH1F *h5 = (TH1F*)file5->Get("h_DeltaPhi_ph_mu1");
h5->Rebin(100);
...
TH1F *h6 = (TH1F*)file6->Get("h_DeltaPhi_ph_mu1");
h6->Rebin(100);
...
TH1F *h7 = (TH1F*)file7->Get("h_DeltaPhi_ph_mu1");
h7->Rebin(100);
...
TH1F *h8 = (TH1F*)file8->Get("h_DeltaPhi_ph_mu1");
h8->Rebin(100);
...
TH1F *h9 = (TH1F*)file9->Get("h_DeltaPhi_ph_mu1");
h9->Rebin(100);
...
hs.GetXaxis()->SetTitle("#DeltaR(Leading Muon, #gamma)");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_DeltaPhi_ph_mu1");
h_Data->Rebin(100);
...
h_ratio->SetTitle("; #DeltaR(Leading Muon, #gamma); Data/MC Ratio");
...
c1.SaveAs("h_DeltaPhi_ph_mu1_Stacked.pdf");
c1.SaveAs("h_DeltaPhi_ph_mu1_Stacked.png");
}
