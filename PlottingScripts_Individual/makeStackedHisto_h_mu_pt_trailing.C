...
void makeStackedHisto_h_mu_pt_trailing(){
...
TH1F *h1 = (TH1F*)file1->Get("h_mu_pt_trailing");
h1->Rebin(10);
...
TH1F *h2 = (TH1F*)file2->Get("h_mu_pt_trailing");
h2->Rebin(10);
...
TH1F *h3 = (TH1F*)file3->Get("h_mu_pt_trailing");
h3->Rebin(10);
...
TH1F *h4 = (TH1F*)file4->Get("h_mu_pt_trailing");
h4->Rebin(10);
...
TH1F *h5 = (TH1F*)file5->Get("h_mu_pt_trailing");
h5->Rebin(10);
...
TH1F *h6 = (TH1F*)file6->Get("h_mu_pt_trailing");
h6->Rebin(10);
...
TH1F *h7 = (TH1F*)file7->Get("h_mu_pt_trailing");
h7->Rebin(10);
h7->GetXaxis()->SetRangeUser(25, 300);
h7->Scale(DY_SF);
h7->SetFillColor(kBlue);
hs.Add(h7);

TFile* file8 = new TFile("MC_MuMu/Output_LowPtSUSY_Tree_WZJetsTo3LNu_CaloMET_All.root");
TH1F *h8 = (TH1F*)file8->Get("h_mu_pt_trailing");
h8->Rebin(10);
...
TH1F *h9 = (TH1F*)file9->Get("h_mu_pt_trailing");
h9->Rebin(10);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_mu_pt_trailing");
h_Data->Rebin(10);
...
c1.SaveAs("h_mu_pt_trailing_Stacked.pdf");
c1.SaveAs("h_mu_pt_trailing_Stacked.png");
}
