...
void makeStackedHisto_h_DeltaPhi_met_mu2(){
...
THStack hs("hs","#DeltaR(Trailing Muon, PF MET)");

TFile* file1 = TFile::Open("MC_MuMu/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_All.root");
TH1F *h1 = (TH1F*)file1->Get("h_DeltaPhi_met_mu2");
h1->Rebin(100);
...
TH1F *h2 = (TH1F*)file2->Get("h_DeltaPhi_met_mu2");
h2->Rebin(100);
...
TH1F *h3 = (TH1F*)file3->Get("h_DeltaPhi_met_mu2");
h3->Rebin(100);
...
TH1F *h4 = (TH1F*)file4->Get("h_DeltaPhi_met_mu2");
h4->Rebin(100);
...
TH1F *h5 = (TH1F*)file5->Get("h_DeltaPhi_met_mu2");
h5->Rebin(100);
...
TH1F *h6 = (TH1F*)file6->Get("h_DeltaPhi_met_mu2");
h6->Rebin(100);
...
TH1F *h7 = (TH1F*)file7->Get("h_DeltaPhi_met_mu2");
h7->Rebin(100);
...
TH1F *h8 = (TH1F*)file8->Get("h_DeltaPhi_met_mu2");
h8->Rebin(100);
...
TH1F *h9 = (TH1F*)file9->Get("h_DeltaPhi_met_mu2");
h9->Rebin(100);
...
hs.GetXaxis()->SetTitle("#DeltaR(Trailing Muon, PF MET)");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_DeltaPhi_met_mu2");
h_Data->Rebin(100);
...
h_ratio->SetTitle("; #DeltaR(Trailing Muon, PF MET); Data/MC Ratio");
...
c1.SaveAs("h_DeltaPhi_met_mu2_Stacked.pdf");
c1.SaveAs("h_DeltaPhi_met_mu2_Stacked.png");
}
