...
fileNames = cms.untracked.vstring('file:/uscms_data/d1/sapta/work/SUSYSearch/SignalGeneration/Pythiadecay/CMSSW_5_3_16_patch1/src/run_Stop200_pta20/PostProc_unweighted_events_Stop200_Pta20.lhe')
#fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/s/sapta/SUSYSignalGeneration/CMSSW_5_3_9/src/run_WoffShell/PostProc_run_WoffShell.lhe')
)
...
'MSTP(163)=69',
		...
		'SLHAFILE = decay_PythiaCard_WoffShell.dat'),
