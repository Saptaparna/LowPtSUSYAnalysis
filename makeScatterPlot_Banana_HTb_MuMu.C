...
TH2F *h1 = (TH2F*)gDirectory->Get("h_HTb_MmumuGamma");
h1->RebinX(10);
h1->RebinY(10);
...
h1->SetStats(kFALSE);
h1->SetTitle("HTb versus M_{ll#gamma}");
h1->GetXaxis()->SetLabelSize(0.03);
h1->GetYaxis()->SetLabelSize(0.03);
h1->GetXaxis()->SetTitle("HTb [GeV]");
h1->GetYaxis()->SetTitle("M_{ll#gamma} [GeV]");
h1->GetXaxis()->SetRangeUser(0.0, 300);
h1->GetYaxis()->SetRangeUser(0.0, 400);
h1->GetYaxis()->SetTitleOffset(1.2);
h1->SetLineColor(kBlue);
h1->Draw();

TFile* file2 = TFile::Open((infile2+".root").c_str());
TH2F *h2 = (TH2F*)gDirectory->Get("h_HTb_MmumuGamma");
h2->RebinX(100);
h2->RebinY(100);
...
TH2F *h3 = (TH2F*)gDirectory->Get("h_HTb_MmumuGamma");
h3->RebinX(10);
h3->RebinY(10);
...
c1->SaveAs((infile1+"_HTb.pdf").c_str());
c1->SaveAs((infile1+"_HTb.png").c_str());
