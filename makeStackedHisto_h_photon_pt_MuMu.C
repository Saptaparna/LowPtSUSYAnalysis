...
void makeStackedHisto_h_photon_pt_MuMu(){
...
TH1F *hSS = (TH1F*)fileSS->Get("h_photon_pt_MuMu");
hSS->Rebin(20);
...
//hs.GetXaxis()->SetTitle("Leading photon p_{T} [GeV]");
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_photon_pt_MuMu");
h_Signal->Rebin(20);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_photon_pt_MuMu");
...
h_ratio->SetTitle("; #bf{Leading photon p_{T} [GeV]}; Data/MC Ratio");
...
gStyle->SetHatchesLineWidth(4);
gStyle->SetErrorX(0.5);
h_ratio_Unc->GetXaxis()->SetRangeUser(32, 300.0);
