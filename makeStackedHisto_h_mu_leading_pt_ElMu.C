...
void makeStackedHisto_h_mu_leading_pt_ElMu(){
...
TH1F *hSS = (TH1F*)fileSS->Get("h_mu_pt_leading_ElMu");
hSS->Rebin(20);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_mu_pt_leading_ElMu");
...
h_ratio->SetLabelSize(0.055);
h_ratio->SetTitleSize(0.055);
h_ratio->SetTitle("; Leading muon p_{T} (GeV); Data/MC Ratio");
...
gStyle->SetHatchesLineWidth(4);
gStyle->SetErrorX(0.5);
h_ratio_Unc->GetXaxis()->SetRangeUser(0, 180);
