...
cout << "Integral data driven = " << h0->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral SS = " << hSS->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral ZG tau tau = " << h1a->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral TTG = " << h2->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral WGstar = " << h3->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral ZZ = " << h4->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral T_tW = " << h5->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral Tbar_tW = " << h6->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral WZ = " << h8->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral WWG = " << h9->Integral(xbin_low, xbin_high) << endl;
...
cout << "Integral data = " << h_Data->Integral(xbin_low, xbin_high) << endl;
...
for (int ibin = 1; ibin < h_AllMC_Unc->GetNbinsX()+1; ibin++){
  ...
  double uncSyst = 0;
  double uncTot  = 0;
  uncStat += hSS->GetBinError(ibin)*hSS->GetBinError(ibin)
...
TBox *blot=new TBox(0, -0.5, 50, 3.0);
