...
TH1F *h0 = (TH1F*)file0->Get("h_caloMET_ElMu");
h0->Rebin(10);
...
TH1F *h1 = (TH1F*)file1->Get("h_caloMET_ElMu");
h1->Rebin(10);
...
TH1F *h1a = (TH1F*)file1a->Get("h_caloMET_ElMu");
h1a->Rebin(10);
...
TH1F *h2 = (TH1F*)file2->Get("h_caloMET_ElMu");
h2->Rebin(10);
...
TH1F *h3 = (TH1F*)file3->Get("h_caloMET_ElMu");
h3->Rebin(10);
...
TH1F *h4 = (TH1F*)file4->Get("h_caloMET_ElMu");
h4->Rebin(10);
...
TH1F *h5 = (TH1F*)file5->Get("h_caloMET_ElMu");
h5->Rebin(10);
...
TH1F *h6 = (TH1F*)file6->Get("h_caloMET_ElMu");
h6->Rebin(10);
...
TH1F *h8 = (TH1F*)file8->Get("h_caloMET_ElMu");
h8->Rebin(10);
...
TH1F *h9 = (TH1F*)file9->Get("h_caloMET_ElMu");
h9->Rebin(10);
...
hs.GetXaxis()->SetTitle("caloMET (GeV)");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_caloMET_ElMu");
h_Data->Rebin(10);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_MET");
h_Signal->Rebin(10);
h_Signal->GetXaxis()->SetRangeUser(35, 300);
...
h_ratio->SetTitle("; caloMET (GeV); Data/MC Ratio");
...
c1.SaveAs("h_caloMET_ElMu_Stacked.pdf");
c1.SaveAs("h_caloMET_ElMu_Stacked.png");
}
