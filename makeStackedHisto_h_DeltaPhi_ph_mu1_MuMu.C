...
THStack hs("hs","#Delta#phi(#gamma, leading muon)");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_DeltaPhi_ph_mu1_MuMu");
hSS->Rebin(100);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_DeltaPhi_ph_mu1_MuMu");
...
h_ratio->SetTitle("; #bf{#Delta#phi(#gamma, leading muon)}; Data/MC Ratio");
