...
TH1F *hSS = (TH1F*)fileSS->Get("h_HT_MuMu");
hSS->Rebin(20);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_HT_MuMu");
h_Signal->Rebin(20);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_HT_MuMu");
...
h_ratio->SetTitle("; #bf{HT (GeV)}; Data/MC Ratio");
...
TF1 *fit_ratio = new TF1("fit_ratio","[0]*x + [1]", 150, 500.0);
...
TBox *blot=new TBox(0, -0.5, 150, 3.0);
