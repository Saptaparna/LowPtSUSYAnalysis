...
void makeStackedHisto_h_nbJets_MuMu(){
...
THStack hs("hs","Number of b-jets");

TFile* file0 = TFile::Open("MC_OS/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_All.root");
TH1F *h0 = (TH1F*)file0->Get("h_nbJets_MuMu");
h0->Rebin(1);
h0->GetXaxis()->SetRangeUser(-0.5, 9.5);
...
hs.SetMinimum(1.0);
hs.GetXaxis()->SetRangeUser(-0.5, 9.5);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_nbJets_MuMu");
h_Data->Rebin(1);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(-0.5, 9.5);
h_Data->Draw("SAME E");

TFile* file_Signal = TFile::Open("Signal/Output_LowPtSUSY_Tree_Stop100_Chargino75_Neutralino30_Ntuple_Pta20.root");
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_nbJets_MuMu");
h_Signal->Rebin(1);
h_Signal->GetXaxis()->SetRangeUser(-0.5, 9.5);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_nbJets_MuMu");
h_Signal_Stop->Rebin(1);
h_Signal_Stop->GetXaxis()->SetRangeUser(-0.5, 9.5);
...
h_ratio->SetTitle("; #bf{Number of b-jets}; Data/MC Ratio");
...
gStyle->SetHatchesLineWidth(4);
gStyle->SetErrorX(0.5);
h_ratio_Unc->GetXaxis()->SetRangeUser(-0.5, 3.5);
...
c1.SaveAs("h_nbJets_MuMu_Stacked.pdf");
c1.SaveAs("h_nbJets_MuMu_Stacked.png");
}
