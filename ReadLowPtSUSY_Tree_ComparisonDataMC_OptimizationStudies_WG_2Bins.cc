...
int ReadLowPtSUSY_Tree_ComparisonDataMC_OptimizationStudies_WG_2Bins(std::string infile, std::string outfile, std::string type, std::string signSelection, std::string MCSample){
  ...
  TH1F *h_HT_LowCutValue_mumu = new TH1F("h_HT_LowCutValue_mumu", "Scatter Plot of HT (MuMu Channel); HT [GeV]", 34, 25.0, 705.0);  h_HT_LowCutValue_mumu->Sumw2();
  TH1F *h_HTb_LowCutValue_mumu = new TH1F("h_HTb_LowCutValue_mumu", "Scatter Plot of HTb (MuMu Channel); HTb [GeV]", 34, 25.0, 705.0);  h_HTb_LowCutValue_mumu->Sumw2();

  TH1F *h_HT_LowCutValue_emu = new TH1F("h_HT_LowCutValue_emu", "Scatter Plot of HT (MuMu Channel); HT [GeV]", 34, 25.0, 705.0);  h_HT_LowCutValue_emu->Sumw2();
  TH1F *h_HTb_LowCutValue_emu = new TH1F("h_HTb_LowCutValue_emu", "Scatter Plot of HTb (MuMu Channel); HTb [GeV]", 34, 25.0, 705.0);  h_HTb_LowCutValue_emu->Sumw2();

  TH1F *h_HTz_InvMass_mumu = new TH1F("h_HTz_InvMass_mumu", "Mll optimization (MuMu Channel); Mll [GeV]", 29, 0.0, 290.0); h_HTz_InvMass_mumu->Sumw2();
  TH1F *h_HTbz_InvMass_mumu = new TH1F("h_HTbz_InvMass_mumu", "Mll optimization (MuMu Channel); Mll [GeV]", 29, 0.0, 290.0); h_HTbz_InvMass_mumu->Sumw2();
  TH1F *h_HTz_InvMass_emu = new TH1F("h_HTz_InvMass_emu", "Mll optimization (ElMu Channel); Mll [GeV]", 29, 0.0, 290.0); h_HTz_InvMass_emu->Sumw2();
  TH1F *h_HTbz_InvMass_emu = new TH1F("h_HTbz_InvMass_emu", "Mll optimization (ElMu Channel); Mll [GeV]", 29, 0.0, 290.0); h_HTbz_InvMass_emu->Sumw2(); 

  TH2F *h_HT_Mmumu_LowCutValue = new TH2F("h_HT_Mmumu_LowCutValue", "Scatter Plot of HT versus M_{#mu#mu}; HT [GeV]; M_{#mu#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HT_Mmumu_LowCutValue->Sumw2();
  TH2F *h_HT_Mmumu_HighCutValue = new TH2F("h_HT_Mmumu_HighCutValue", "Scatter Plot of HT versus M_{#mu#mu}; HT [GeV]; M_{#mu#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HT_Mmumu_HighCutValue->Sumw2();
  TH2F *h_HT_MmumuGamma_LowCutValue = new TH2F("h_HT_MmumuGamma_LowCutValue", "Scatter Plot of HT versus M_{#mu#mu#gamma}; HT [GeV]; M_{#mu#mu#gamma} [GeV]", 34, 25.0, 705.0, 14, 0.0, 280.0);  h_HT_MmumuGamma_LowCutValue->Sumw2();

  TH2F *h_HT_Memu_LowCutValue = new TH2F("h_HT_Memu_LowCutValue", "Scatter Plot of HT versus M_{e#mu}; HT [GeV]; M_{e#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HT_Memu_LowCutValue->Sumw2();

  TH2F *h_HT_Memu_HighCutValue = new TH2F("h_HT_Memu_HighCutValue", "Scatter Plot of HT versus M_{e#mu}; HT [GeV]; M_{e#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HT_Memu_HighCutValue->Sumw2();
 
  TH2F *h_HT_MemuGamma_LowCutValue = new TH2F("h_HT_MemuGamma_LowCutValue", "Scatter Plot of HT versus M_{e#mu#gamma}; HT [GeV]; M_{e#mu#gamma} [GeV]", 34, 25.0, 705.0, 14, 0.0, 280.0);  h_HT_MemuGamma_LowCutValue->Sumw2();

  TH2F *h_HTb_Mmumu_LowCutValue = new TH2F("h_HTb_Mmumu_LowCutValue", "Scatter Plot of HTb versus M_{#mu#mu}; HTb [GeV]; M_{#mu#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HTb_Mmumu_LowCutValue->Sumw2();

  TH2F *h_HTb_Mmumu_HighCutValue = new TH2F("h_HTb_Mmumu_HighCutValue", "Scatter Plot of HTb versus M_{#mu#mu}; HTb [GeV]; M_{#mu#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HTb_Mmumu_HighCutValue->Sumw2();
  TH2F *h_HTb_MmumuGamma_LowCutValue = new TH2F("h_HTb_MmumuGamma_LowCutValue", "Scatter Plot of HTb versus M_{#mu#mu#gamma}; HTb [GeV]; M_{#mu#mu#gamma} [GeV]", 34, 25.0, 705.0, 14, 0.0, 280.0);  h_HTb_MmumuGamma_LowCutValue->Sumw2();

  TH2F *h_HTb_Memu_LowCutValue = new TH2F("h_HTb_Memu_LowCutValue", "Scatter Plot of HTb versus M_{e#mu}; HTb [GeV]; M_{e#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HTb_Memu_LowCutValue->Sumw2();
  TH2F *h_HTb_Memu_HighCutValue = new TH2F("h_HTb_Memu_HighCutValue", "Scatter Plot of HTb versus M_{e#mu}; HTb [GeV]; M_{e#mu} [GeV]", 34, 25.0, 705.0, 29, 0.0, 290.0);  h_HTb_Memu_HighCutValue->Sumw2();

  TH2F *h_HTb_MemuGamma_LowCutValue = new TH2F("h_HTb_MemuGamma_LowCutValue", "Scatter Plot of HTb versus M_{e#mu#gamma}; HTb [GeV]; M_{e#mu#gamma} [GeV]", 34, 25.0, 705.0, 14, 0.0, 280.0);  h_HTb_MemuGamma_LowCutValue->Sumw2();

  TH2F *h_HT_SVFitmumu_LowCutValue = new TH2F("h_HT_SVFitmumu_LowCutValue", "Scatter Plot of HT versus M_{#mu#mu}; HT [GeV]; M_{#mu#mu} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HT_SVFitmumu_LowCutValue->Sumw2();
  TH2F *h_HT_SVFitmumuGamma_LowCutValue = new TH2F("h_HT_SVFitmumuGamma_LowCutValue", "Scatter Plot of HT versus M_{#mu#mu#gamma}; HT [GeV]; M_{#mu#mu#gamma} [GeV]",  34, 25.0, 705.0, 24, 0.0, 480.0);  h_HT_SVFitmumuGamma_LowCutValue->Sumw2();

  TH2F *h_HT_SVFitemu_LowCutValue = new TH2F("h_HT_SVFitemu_LowCutValue", "Scatter Plot of HT versus M_{e#mu}; HT [GeV]; M_{e#mu} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HT_SVFitemu_LowCutValue->Sumw2();
  TH2F *h_HT_SVFitemuGamma_LowCutValue = new TH2F("h_HT_SVFitemuGamma_LowCutValue", "Scatter Plot of HT versus M_{e#mu#gamma}; HT [GeV]; M_{e#mu#gamma} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HT_SVFitemuGamma_LowCutValue->Sumw2();

  TH2F *h_HTb_SVFitmumu_LowCutValue = new TH2F("h_HTb_SVFitmumu_LowCutValue", "Scatter Plot of HTb versus M_{#mu#mu}; HTb [GeV]; M_{#mu#mu} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HTb_SVFitmumu_LowCutValue->Sumw2();
  TH2F *h_HTb_SVFitmumuGamma_LowCutValue = new TH2F("h_HTb_SVFitmumuGamma_LowCutValue", "Scatter Plot of HTb versus M_{#mu#mu#gamma}; HTb [GeV]; M_{#mu#mu#gamma} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HTb_SVFitmumuGamma_LowCutValue->Sumw2();

  TH2F *h_HTb_SVFitemu_LowCutValue = new TH2F("h_HTb_SVFitemu_LowCutValue", "Scatter Plot of HTb versus M_{e#mu}; HTb [GeV]; M_{e#mu} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HTb_SVFitemu_LowCutValue->Sumw2();
  TH2F *h_HTb_SVFitemuGamma_LowCutValue = new TH2F("h_HTb_SVFitemuGamma_LowCutValue", "Scatter Plot of HTb versus M_{e#mu#gamma}; HTb [GeV]; M_{e#mu#gamma} [GeV]", 34, 25.0, 705.0, 24, 0.0, 480.0);  h_HTb_SVFitemuGamma_LowCutValue->Sumw2();
  ...
  double HT_Yield_MuMu[35], InvMass_Yield_MuMu[35], HTb_Yield_MuMu[35], InvMassHTz_Yield_MuMu[35], InvMassHTbz_Yield_MuMu[35];
  double HT_Yield_ElMu[35], InvMass_Yield_ElMu[35], HTb_Yield_ElMu[35], InvMassHTz_Yield_ElMu[35], InvMassHTbz_Yield_ElMu[35];
  ...
  for(unsigned int i=0; i<35; ++i){
    ...
    InvMassHTz_Yield_MuMu[i] = 0.0;
    InvMassHTbz_Yield_MuMu[i] = 0.0; 
  ...
  for(unsigned int i=0; i<35; ++i){
    ...
    InvMassHTz_Yield_ElMu[i] = 0.0;
    InvMassHTbz_Yield_ElMu[i] = 0.0;
   ...
   for(unsigned int k=0; k<photons.size(); ++k)
   {
     ...
     //if(fabs(photons.at(k).eta)<1.444 and photons.at(k).pT>30.0 and photons.at(k).isLoose==1 and photons.at(k).phIsoLoose==1 and photons.at(k).phpixelVeto==0)// and photons.at(k).phSigmaIetaIeta > 0.001 and photons.at(k).phSigmaIphiIphi>0.0001 and swissCross.at(k)<0.90)// and photons.at(k).phSigmaIphiIphi>0.0001)// and swissCross.at(k)<0.90)
    {
       ...
       for(unsigned int j=0; j<muons.size(); ++j)
         ...
         //if(muons.at(j).pT > 3.0 and muons.at(j).isLoose==1 and muons.at(j).isLooseWG==1 and muons.at(j).isolation < 0.20 and fabs(muons.at(j).dxy)<0.01 and fabs(muons.at(j).dz)<0.1){
...
//        if(electrons.at(j).pT > 7.0 and electrons.at(j).isLooseWG==1 and electrons.at(j).isolation < 0.50 and electrons.at(j).isolation*electrons.at(j).pT < 5.0 and fabs(electrons.at(j).dxy)<0.01 and fabs(electrons.at(j).dz)<0.1)
   ...
   for(unsigned int m=0; m<muons.size(); ++m)
     {
       ...
       //if(muons.at(m).pT > 3.0 and muons.at(m).isLoose==1 and muons.at(m).isLooseWG==1 and muons.at(m).isolation < 0.20 and fabs(muons.at(m).dxy)<0.01 and fabs(muons.at(m).dz)<0.1){
  ...
  if(eventWeight > 0.0 and Muons.size()==2){ 
      ...
      if(signSelection=="OS" and (Muons.at(0).Charge*Muons.at(1).Charge)==-1){
       ...
       unsigned int u_invmassHTz=0;
       for(float invmassHTz=0; invmassHTz<300; invmassHTz+=10){
         if((int)HT==(int)0.0) InvMassHTz_Yield_MuMu[u_invmassHTz] += eventWeight;
         if((int)HT==(int)0.0) h_HTz_InvMass_mumu->Fill(invmassHTz, eventWeight);
         ++u_invmassHTz;
       }
       
       unsigned int u_invmassHTbz=0;
       for(float invmassHTbz=0; invmassHTbz<300; invmassHTbz+=10){
         if((int)HTb==(int)0.0) InvMassHTbz_Yield_MuMu[u_invmassHTbz] += eventWeight;
         if((int)HTb==(int)0.0) h_HTbz_InvMass_mumu->Fill(invmassHTbz, eventWeight);
         ++u_invmassHTbz;
       }
       ...
       if(HT > 0.0){
       unsigned int i_ht=0;
       for(float ht=25.0; ht<725.0;ht+=20.0){
 ...
 //ElMu channel
   if( eventWeight > 0.0 and Muons.size()==1 and Electrons.size()==1) {
     ...
     if(signSelection=="OS" and ((Muons.at(0).Charge)*(Electrons.at(0).Charge)==-1)){
       ...
       unsigned int u_invmassHTz=0;
       for(float invmassHTz=0; invmassHTz<300; invmassHTz+=10){
         if((int)HT==(int)0.0) InvMassHTz_Yield_ElMu[u_invmassHTz] += eventWeight;
         if((int)HT==(int)0.0) h_HTz_InvMass_emu->Fill(invmassHTz, eventWeight);
         ++u_invmassHTz;
       }

       unsigned int u_invmassHTbz=0;
       for(float invmassHTbz=0; invmassHTbz<300; invmassHTbz+=10){
         if((int)HTb==(int)0.0) InvMassHTbz_Yield_ElMu[u_invmassHTbz] += eventWeight;
         if((int)HTb==(int)0.0) h_HTbz_InvMass_emu->Fill(invmassHTbz, eventWeight);
         ++u_invmassHTbz;
       }
       ...
       for(float ht=30; ht<730;ht+=20){
          ...
          if(HT<float(ht)) h_HT_LowCutValue_emu->Fill(ht, eventWeight);
          ++u_ht;
       }
       ...
       for(float htb=30; htb<730; htb+=20.0){
          ...
          if(HTb<htb) h_HTb_LowCutValue_emu->Fill(htb, eventWeight);
          ++t_htb;
       }
 ...
 //ElEl channel
  ...
  cout << "Only HT optimization with HTb"<< endl;

  for(int s=0; s<35.00; s++){
    std::cout << "HT = " << s*20+30 << " and HT_Yield ElMu = " << HT_Yield_ElMu[s] << std::endl;
  }

  cout << "Only Invariant mass optimization with HTb" << endl;

  for(int t=0; t<35.00; t++){
    std::cout << "Inv mass = " << t*10 << " and InvMass_Yield ElMu = " << InvMass_Yield_ElMu[t] << std::endl;
  }

  cout << "Only Invariant mass optimization with HT between 0-30" << endl;

  for(int t=0; t<35.00; t++){
     std::cout << "Inv mass = " << t*10 << " and InvMass_Yield ElMu HT zero = " << InvMassHTz_Yield_ElMu[t] << std::endl;
  }

  cout << "Only Invariant mass optimization with HTb between 0-30" << endl;
  
  for(int t=0; t<35.00; t++){
     std::cout << "Inv mass = " << t*10 << " and InvMass_Yield ElMu HTb zero = " << InvMassHTbz_Yield_ElMu[t] << std::endl;
  }
 ...
 for(int l=0; l<35.0; l++){
  ...
  for(int l=0; l<35.0; l++){
   ...
   cout << "Only HTb optimization with HTb" << endl;
 ...
 cout << "3D HT, invariant mass and met optimization" << endl;
  ...
  h_HTbz_InvMass_emu->Write();
  h_HTz_InvMass_emu->Write();
  h_HTbz_InvMass_mumu->Write();
  h_HTz_InvMass_mumu->Write();
  tFile->Close(); 
