...
void makeStackedHisto_h_nJets_ElMu(){
...
TH1F *h0 = (TH1F*)file0->Get("h_nJets_ElMu");
h0->Rebin(1);
...
TH1F *hSS = (TH1F*)fileSS->Get("h_nJets_ElMu");
hSS->Rebin(1);
...
TH1F *h1 = (TH1F*)file1->Get("h_nJets_ElMu");
h1->Rebin(1);
...
TH1F *h1a = (TH1F*)file1a->Get("h_nJets_ElMu");
h1a->Rebin(1);
...
TH1F *h2 = (TH1F*)file2->Get("h_nJets_ElMu");
h2->Rebin(1);
...
TH1F *h3 = (TH1F*)file3->Get("h_nJets_ElMu");
h3->Rebin(1);
...
TH1F *h4 = (TH1F*)file4->Get("h_nJets_ElMu");
h4->Rebin(1);
...
TH1F *h5 = (TH1F*)file5->Get("h_nJets_ElMu");
h5->Rebin(1);
...
TH1F *h6 = (TH1F*)file6->Get("h_nJets_ElMu");
h6->Rebin(1);
...
TH1F *h8 = (TH1F*)file8->Get("h_nJets_ElMu");
h8->Rebin(1);
...
TH1F *h9 = (TH1F*)file9->Get("h_nJets_ElMu");
h9->Rebin(1);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_nJets_ElMu");
h_Data->Rebin(1);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_nJets_ElMu");
h_Signal->Rebin(1);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_nJets_ElMu");
...
h_ratio->SetTitle("; Number of jets; Data/MC Ratio");
...
c1.SaveAs("h_nJets_ElMu_Stacked.pdf");
c1.SaveAs("h_nJets_ElMu_Stacked.png");
}
