...
bool returnDenPhoton(PhotonInfo pho1)
{

  if(pho1.phR9 > 0.9 and pho1.phHoE < 0.05 and
     pho1.phSigmaIetaIeta < 0.015 and pho1.phpixelVeto==0 and
     pho1.chIsolation < min(5*4.0, 0.2*pho1.pT) and
     pho1.nuIsolation < min(5*(4.5 + 0.04*pho1.pT), 0.2*pho1.pT) and
     pho1.phIsolation < min(5*(4.5 + 0.005*pho1.pT), 0.2*pho1.pT) and
     (pho1.phSigmaIetaIeta > 0.012 or
      pho1.chIsolation > 4.0 or
      pho1.nuIsolation > (4.5 + 0.04*pho1.pT) or
      pho1.phIsolation > (4.5 + 0.005*pho1.pT))) return true;
...
/*
bool returnDenPhoton(PhotonInfo pho1) //test for Greg
{

  if(pho1.phR9 > 0.9 and pho1.phHoE < 0.05 and
     pho1.phSigmaIetaIeta < 0.015 and pho1.phpixelVeto==0 and
     pho1.chIsolation < min(5*4.0, 0.1*pho1.pT) and
     pho1.nuIsolation < min(5*(4.5 + 0.04*pho1.pT), 0.1*pho1.pT) and
     pho1.phIsolation < min(5*(4.5 + 0.005*pho1.pT), 0.1*pho1.pT) and
     (pho1.phSigmaIetaIeta > 0.012 or
      pho1.chIsolation > 4.0 or
      pho1.nuIsolation > (4.0 	+ 0.04*pho1.pT) or
      pho1.phIsolation > (4.0 + 0.005*pho1.pT))) return true;
