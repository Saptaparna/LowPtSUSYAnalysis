...
void makeStackedHisto_h_mu_leading_pt_MuMu(){
...
THStack hs("hs","Leading muon p_{T} [GeV]");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_mu_pt_leading_MuMu");
hSS->Rebin(20);
...
//hs.GetXaxis()->SetTitle("Leading muon p_{T} (GeV)");
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_mu_pt_leading_MuMu");
...
h_ratio->SetTitle("; #bf{Leading muon p_{T} [GeV]}; Data/MC Ratio");
...
gStyle->SetHatchesLineWidth(4);
gStyle->SetErrorX(0.5);
h_ratio_Unc->GetXaxis()->SetRangeUser(0, 300.0);
