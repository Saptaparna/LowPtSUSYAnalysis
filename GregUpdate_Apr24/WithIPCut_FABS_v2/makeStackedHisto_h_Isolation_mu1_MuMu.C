...
void makeStackedHisto_h_Isolation_mu1_MuMu(){
...
TH1F *hSS = (TH1F*)fileSS->Get("h_Isolation_mu1_MuMu");
hSS->Rebin(1000);
...
TH1F *h1 = (TH1F*)file1->Get("h_Isolation_mu1_MuMu");
h1->Rebin(1000);
...
TH1F *h1a = (TH1F*)file1a->Get("h_Isolation_mu1_MuMu");
h1a->Rebin(1000);
...
TH1F *h2 = (TH1F*)file2->Get("h_Isolation_mu1_MuMu");
h2->Rebin(1000);
...
TH1F *h3 = (TH1F*)file3->Get("h_Isolation_mu1_MuMu");
h3->Rebin(1000);
...
TH1F *h4 = (TH1F*)file4->Get("h_Isolation_mu1_MuMu");
h4->Rebin(1000);
...
TH1F *h5 = (TH1F*)file5->Get("h_Isolation_mu1_MuMu");
h5->Rebin(1000);
...
TH1F *h6 = (TH1F*)file6->Get("h_Isolation_mu1_MuMu");
h6->Rebin(1000);
...
TH1F *h8 = (TH1F*)file8->Get("h_Isolation_mu1_MuMu");
h8->Rebin(1000);
...
TH1F *h9 = (TH1F*)file9->Get("h_Isolation_mu1_MuMu");
h9->Rebin(1000);
...
hs.GetXaxis()->SetTitle("Isolation: Leading Muon");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_Isolation_mu1_MuMu");
h_Data->Rebin(1000);
...
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_Isolation_mu1_MuMu");
h_Signal->Rebin(1000);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_Isolation_mu1_MuMu");
...
h_ratio->SetTitle("; Isolation: Leading Muon; Data/MC Ratio");
...
c1.SaveAs("h_Isolation_mu1_MuMu_Stacked.pdf");
c1.SaveAs("h_Isolation_mu1_MuMu_Stacked.png");
}
