...
void makeStackedHisto_h_mu_dxy_trailing_MuMu(){
...
THStack hs("hs","Dxy: Trailing Muon");

TFile* file0 = TFile::Open("MC_OS/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_All.root");
TH1F *h0 = (TH1F*)file0->Get("h_mu_dxy_trailing_MuMu");
h0->Rebin(100);
h0->GetXaxis()->SetRangeUser(-0.02, 0.02);
h0->Scale(ZGammaLL_SF*(115.118/2332.79)); //Loose OP
...
TH1F *hSS = (TH1F*)fileSS->Get("h_mu_dxy_trailing_MuMu");
hSS->Rebin(100);
hSS->GetXaxis()->SetRangeUser(-0.02, 0.02);
hSS->SetFillColor(kRed+3);
hs.Add(hSS);

TFile* file1 = TFile::Open("MC_OS/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_MuMu.root");
TH1F *h1 = (TH1F*)file1->Get("h_mu_dxy_trailing_MuMu");
h1->Rebin(100);
h1->GetXaxis()->SetRangeUser(-0.02, 0.02);
h1->Scale(ZGammaLL_SF);
h1->SetFillColor(kRed);
hs.Add(h1);

TFile* file1a = TFile::Open("MC_OS/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_TauTau.root");
TH1F *h1a = (TH1F*)file1a->Get("h_mu_dxy_trailing_MuMu");
h1a->Rebin(100);
h1a->GetXaxis()->SetRangeUser(-0.02, 0.02);
...
TH1F *h2 = (TH1F*)file2->Get("h_mu_dxy_trailing_MuMu");
h2->Rebin(100);
...
hs.SetMinimum(0.1);
hs.GetXaxis()->SetRangeUser(-0.02, 0.02);
hs.GetXaxis()->SetTitle("Dxy: Trailing Muon (cm)");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_mu_dxy_trailing_MuMu");
h_Data->Rebin(100);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(-0.02, 0.02);
h_Data->Draw("SAME E");

TFile* file_Signal = TFile::Open("Signal/Output_LowPtSUSY_Tree_Stop100_Chargino75_Neutralino30_Ntuple_Pta20.root");
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_mu_dxy_trailing_MuMu");
h_Signal->Rebin(100);
h_Signal->GetXaxis()->SetRangeUser(-0.02, 0.02);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_mu_dxy_trailing_MuMu");
h_Signal_Stop->Rebin(100);
h_Signal_Stop->GetXaxis()->SetRangeUser(-0.02, 0.02);
...
h_ratio->SetTitle("; Dxy: Trailing Muon (cm); Data/MC Ratio");
...
c1.SaveAs("h_mu_dxy_trailing_MuMu_Stacked.pdf");
c1.SaveAs("h_mu_dxy_trailing_MuMu_Stacked.png");
}
