...
void makeStackedHisto_h_Isolation_mu2_MuMu(){
...
THStack hs("hs","Isolation: Trailing Muon ");

TFile* file0 = TFile::Open("MC_OS/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_All.root");
TH1F *h0 = (TH1F*)file0->Get("h_Isolation_mu2_MuMu");
h0->Rebin(1000);
...
TH1F *hSS = (TH1F*)fileSS->Get("h_Isolation_mu2_MuMu");
hSS->Rebin(1000);
hSS->GetXaxis()->SetRangeUser(0, 0.6);
hSS->SetFillColor(kRed+3);
hs.Add(hSS);

TFile* file1 = TFile::Open("MC_OS/Output_LowPtSUSY_Tree_ZGToLLG_8TeV_CaloMET_MuMu.root");
TH1F *h1 = (TH1F*)file1->Get("h_Isolation_mu2_MuMu");
h1->Rebin(1000);
...
TH1F *h1a = (TH1F*)file1a->Get("h_Isolation_mu2_MuMu");
h1a->Rebin(1000);
h1a->GetXaxis()->SetRangeUser(0, 0.6);
...
TH1F *h2 = (TH1F*)file2->Get("h_Isolation_mu2_MuMu");
h2->Rebin(1000);
h2->GetXaxis()->SetRangeUser(0, 0.6);
h2->Scale(TTG_SF);
h2->SetFillColor(kCyan);
hs.Add(h2);

TFile* file3 = new TFile("MC_OS/Output_LowPtSUSY_Tree_WGstarToLNu2Mu_TuneZ2star_CaloMET_All.root");
TH1F *h3 = (TH1F*)file3->Get("h_Isolation_mu2_MuMu");
h3->Rebin(1000);
...
hs.SetMinimum(0.1);
hs.GetXaxis()->SetRangeUser(0, 0.6);
hs.GetXaxis()->SetTitle("Isolation: Trailing Muon");
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_Isolation_mu2_MuMu");
h_Data->Rebin(1000);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(0, 0.6);
h_Data->Draw("SAME E");

TFile* file_Signal = TFile::Open("Signal/Output_LowPtSUSY_Tree_Stop100_Chargino75_Neutralino30_Ntuple_Pta20.root");
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_Isolation_mu2_MuMu");
h_Signal->Rebin(1000);
h_Signal->GetXaxis()->SetRangeUser(0, 0.6);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_Isolation_mu2_MuMu");
h_Signal_Stop->Rebin(1000);
h_Signal_Stop->GetXaxis()->SetRangeUser(0, 0.6);
...
h_ratio->SetTitle("; Isolation: Trailing Muon; Data/MC Ratio");
...
c1.SaveAs("h_Isolation_mu2_MuMu_Stacked.pdf");
c1.SaveAs("h_Isolation_mu2_MuMu_Stacked.png");
}
