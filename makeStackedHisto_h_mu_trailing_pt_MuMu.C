...
void makeStackedHisto_h_mu_trailing_pt_MuMu(){
...
THStack hs("hs","Trailing muon p_{T} [GeV]");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_mu_pt_trailing_MuMu");
hSS->Rebin(10);
...
//hs.GetXaxis()->SetTitle("Trailing muon p_{T} (GeV)");
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_mu_pt_trailing_MuMu");
...
h_ratio->SetTitle("; #bf{Trailing muon p_{T} [GeV]}; Data/MC Ratio");
...
gStyle->SetHatchesLineWidth(4);
gStyle->SetErrorX(0.5);
h_ratio_Unc->GetXaxis()->SetRangeUser(0, 160.0);
