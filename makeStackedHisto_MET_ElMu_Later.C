...
void makeStackedHisto_MET_ElMu_Later(){
...
h0->Rebin(20);
h0->GetXaxis()->SetRangeUser(0, 220);
...
hSS->Rebin(20);
hSS->GetXaxis()->SetRangeUser(0, 220);
...
h1->Rebin(20);
h1->GetXaxis()->SetRangeUser(0, 220);
...
h1a->Rebin(20);
h1a->GetXaxis()->SetRangeUser(0, 220);
...
h2->Rebin(20);
h2->GetXaxis()->SetRangeUser(0, 220);
h2->Scale(TTG_SF);
...
h3->Rebin(20);
h3->GetXaxis()->SetRangeUser(0, 220);
h3->Scale(WGSMu_SF);
...
h4->Rebin(20);
h4->GetXaxis()->SetRangeUser(0, 220);
h4->Scale(ZZ_SF);
...
h5->Rebin(20);
h5->GetXaxis()->SetRangeUser(0, 220);
h5->Scale(T_tW_SF);
...
h6->Rebin(20);
h6->GetXaxis()->SetRangeUser(0, 220);
h6->Scale(Tbar_tW_SF);
...
h8->Rebin(20);
h8->GetXaxis()->SetRangeUser(0, 220);
h8->Scale(WZ_SF);
...
h9->Rebin(20);
h9->GetXaxis()->SetRangeUser(0, 220);
h9->Scale(WWG_SF);
...
hs.SetMaximum(500.0);
hs.SetMinimum(0.1);
hs.GetXaxis()->SetRangeUser(0, 220);
...
h_Data->GetXaxis()->SetRangeUser(0, 220);
h_Data->Draw("SAME E");
...
h_Signal->Rebin(20);
h_Signal->GetXaxis()->SetRangeUser(0, 220);
...
h_Signal_Stop->GetXaxis()->SetRangeUser(0, 220);
