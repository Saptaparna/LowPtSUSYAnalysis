...
THStack hs("hs","Stacked Plot of InvMass");
...
TH1F *h10 = (TH1F*)file10->Get("h_InvariantMass_Mu");
h10->Rebin(50);
h10->GetXaxis()->SetRangeUser(50, 120);
...
TH1F *h11 = (TH1F*)file11->Get("h_InvariantMass_Mu");
h11->Rebin(50);
h11->SetLineColor(kBlack);
h11->SetMarkerStyle(20);
h11->SetMarkerSize(1.0);
h11->GetXaxis()->SetRangeUser(50, 120);
h11->Draw("SAME E");
