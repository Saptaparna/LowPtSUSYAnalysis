...
THStack hs("hs","Stacked Plot of PhPt");
...
h7->Rebin(10);
h7->GetXaxis()->SetRangeUser(30, 300);
h7->Scale(WGSMu_SF);
...
TH1F *h10 = (TH1F*)file10->Get("h_photon_pt");
h10->Rebin(10);
h10->GetXaxis()->SetRangeUser(30, 300);
...
TH1F *h11 = (TH1F*)file11->Get("h_photon_pt");
h11->Rebin(10);
h11->SetLineColor(kBlack);
h11->SetMarkerStyle(20);
h11->SetMarkerSize(1.0);
h11->GetXaxis()->SetRangeUser(30, 300);
h11->Draw("SAME E");
