...
h5->Rebin(50);
h5->GetXaxis()->SetRangeUser(25, 450);
h5->Scale(DY_SF);
...
h1->Rebin(50);
h1->GetXaxis()->SetRangeUser(25, 450);
h1->Scale(DY_1050SF);
...
h2->Rebin(50);
h2->GetXaxis()->SetRangeUser(25, 450);
...
h4->Rebin(50);
h4->GetXaxis()->SetRangeUser(25, 450);
h4->Scale(TTG_SF);
...
h6->Rebin(50);
h6->GetXaxis()->SetRangeUser(25, 450);
h6->Scale(TT_SF);
...
h7->Rebin(50);
h7->GetXaxis()->SetRangeUser(25, 450);
h7->Scale(WGSMu_SF);
...
h8->Rebin(50);
h8->GetXaxis()->SetRangeUser(25, 450);
h8->Scale(ZZ_SF);
...
h9->Rebin(50);
h9->GetXaxis()->SetRangeUser(25, 450);
h9->Scale(T_tW_SF);
h9->SetFillColor(kGray);
hs.Add(h9);

TFile* file10 = new TFile("MC_MuMu/Output_LowPtSUSY_Tree_Tbar_tW_All.root");
TH1F *h10 = (TH1F*)file10->Get("h_HT");
h10->Rebin(50);
h10->GetXaxis()->SetRangeUser(25, 450);
