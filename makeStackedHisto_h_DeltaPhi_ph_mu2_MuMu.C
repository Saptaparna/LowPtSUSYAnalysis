...
THStack hs("hs","#Delta#phi(#gamma, trailing muon)");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_DeltaPhi_ph_mu2_MuMu");
hSS->Rebin(100);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_DeltaPhi_ph_mu2_MuMu");
...
TLegend *leg1 = new TLegend(0.62,0.50,0.90,0.90,NULL,"brNDC"); 
...
h_ratio->SetTitle("; #bf{#Delta#phi(#gamma, trailing muon)}; Data/MC Ratio");
