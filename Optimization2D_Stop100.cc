...
void Optimization2D_h_HTb_SVFitemuGamma_LowCutValue(std::string outfile){
  ...
  double signal_stop_SF_100 = (1.66*0.3983*1000*7.4*0.33*0.33*2)/99986;
  double signal_SF = (0.0004318*(7.4)*1000*1000*1.66)/99990;

  TFile* file1 = TFile::Open("SVFitOptimization/Output_ZGToLLG_8TeV_CaloMET_All.root");
  TH2F *h1 = (TH2F*)file1->Get("h_HTb_SVFitemuGamma_LowCutValue");
  //h1->SetLineWidth(3);
  ...
  h1->GetYaxis()->SetTitle("SVFit_{e#mu#gamma} < Cut Value [GeV]");
  h1->GetXaxis()->SetRangeUser(0, 500);
  h1->GetYaxis()->SetRangeUser(0, 600);
  h1->GetYaxis()->SetTitleOffset(1.2);
  //h1->Draw("BOX");

  TFile* file2 = TFile::Open("SVFitOptimization/Output_TTGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h2 = (TH2F*)file2->Get("h_HTb_SVFitemuGamma_LowCutValue");
  h2->SetLineWidth(3);
  h2->SetLineColor(kRed);
  //h2->Draw("BOX SAME");

  TFile* file3 = new TFile("SVFitOptimization/Output_WGstarToLNu2Mu_TuneZ2star_CaloMET_All.root");
  TH2F *h3 = (TH2F*)file3->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file4 = new TFile("SVFitOptimization/Output_ZZJetsTo4L_TuneZ2star_CaloMET_All.root");
  TH2F *h4 = (TH2F*)file4->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file5 = new TFile("SVFitOptimization/Output_T_tW_CaloMET_All.root");
  TH2F *h5 = (TH2F*)file5->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file6 = new TFile("SVFitOptimization/Output_Tbar_tW_CaloMET_All.root");  
  TH2F *h6 = (TH2F*)file6->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file7 = new TFile("SVFitOptimization/Output_WZJetsTo3LNu_CaloMET_All.root");
  TH2F *h7 = (TH2F*)file7->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file8 = new TFile("SVFitOptimization/Output_WWGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h8 = (TH2F*)file8->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file9 = new TFile("SVFitOptimization/Output_SinglePhotonParked_Run2012D_22Jan2013_All.root");
  TH2F *h9 = (TH2F*)file9->Get("h_HTb_SVFitemuGamma_LowCutValue");

  TFile* file10 = TFile::Open("SVFitOptimization/Output_Stop100_Chargino75_Neutralino30_Ntuple_Pta20_All.root");
  TH2F *h10 = (TH2F*)file10->Get("h_HTb_SVFitemuGamma_LowCutValue");
  h10->SetLineWidth(3);
  ...
  for (int j=1; j<=yaxis->GetNbins();j++) {
      for (int i=1; i<=xaxis->GetNbins();i++) {
         ...
         if(sumOfBackgrounds > 0.0) h_Significance->SetBinContent(i, j, (h10->GetBinContent(i, j)*signal_stop_SF_100/
  ...
  c1.SaveAs("h_Significance_h_HTb_SVFitemuGamma_LowCutValue.pdf");
  c1.SaveAs("h_Significance_h_HTb_SVFitemuGamma_LowCutValue.png");
...
void Optimization2D_h_HTb_SVFitemu_LowCutValue(std::string outfile){
  ...
  TFile* file1 = TFile::Open("SVFitOptimization/Output_ZGToLLG_8TeV_CaloMET_All.root");
  TH2F *h1 = (TH2F*)file1->Get("h_HTb_SVFitemu_LowCutValue");
  //h1->SetLineWidth(3);
  h1->SetLineColor(kBlue);
  h1->SetLineWidth(3);
  h1->SetStats(kFALSE);
  ...
  h1->GetYaxis()->SetLabelSize(0.03);
  h1->GetXaxis()->SetTitle("HTb < Cut Value [GeV]");
  h1->GetYaxis()->SetTitle("SVFit_{e#mu} < Cut Value [GeV]");
  h1->GetXaxis()->SetRangeUser(0, 500);
  h1->GetYaxis()->SetRangeUser(0, 600);
  h1->GetYaxis()->SetTitleOffset(1.2);
  //h1->Draw("BOX");
  ...
  TFile* file2 = TFile::Open("SVFitOptimization/Output_TTGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h2 = (TH2F*)file2->Get("h_HTb_SVFitemu_LowCutValue");
  h2->SetLineWidth(3);
  h2->SetLineColor(kRed);
  //h2->Draw("BOX SAME");

  TFile* file3 = new TFile("SVFitOptimization/Output_WGstarToLNu2Mu_TuneZ2star_CaloMET_All.root");
  TH2F *h3 = (TH2F*)file3->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file4 = new TFile("SVFitOptimization/Output_ZZJetsTo4L_TuneZ2star_CaloMET_All.root");
  TH2F *h4 = (TH2F*)file4->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file5 = new TFile("SVFitOptimization/Output_T_tW_CaloMET_All.root");
  TH2F *h5 = (TH2F*)file5->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file6 = new TFile("SVFitOptimization/Output_Tbar_tW_CaloMET_All.root");  
  TH2F *h6 = (TH2F*)file6->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file7 = new TFile("SVFitOptimization/Output_WZJetsTo3LNu_CaloMET_All.root");
  TH2F *h7 = (TH2F*)file7->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file8 = new TFile("SVFitOptimization/Output_WWGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h8 = (TH2F*)file8->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file9 = new TFile("SVFitOptimization/Output_SinglePhotonParked_Run2012D_22Jan2013_All.root");
  TH2F *h9 = (TH2F*)file9->Get("h_HTb_SVFitemu_LowCutValue");

  TFile* file10 = TFile::Open("SVFitOptimization/Output_Stop100_Chargino75_Neutralino30_Ntuple_Pta20_All.root");
  TH2F *h10 = (TH2F*)file10->Get("h_HTb_SVFitemu_LowCutValue");
  h10->SetLineWidth(3);
  h10->SetLineColor(kBlack);
  //h10->Draw("BOX SAME");
  ...
  h_Significance->Draw("COLZ TEXT");
  c1.SaveAs("h_Significance_h_HTb_SVFitemu_LowCutValue.pdf");
  c1.SaveAs("h_Significance_h_HTb_SVFitemu_LowCutValue.png");
  std::string histfilename=(outfile+".root").c_str();
  TFile *tFile=new TFile(histfilename.c_str(), "RECREATE");
  h1->Write("h_ZGToLLG");
  h2->Write("h_TTG");
...
void Optimization2D_h_HT_SVFitemuGamma_LowCutValue(std::string outfile){
  ...
  TFile* file1 = TFile::Open("SVFitOptimization/Output_ZGToLLG_8TeV_CaloMET_All.root");
  TH2F *h1 = (TH2F*)file1->Get("h_HT_SVFitemuGamma_LowCutValue");
  //h1->SetLineWidth(3);
  h1->SetLineColor(kBlue);
  h1->SetLineWidth(3);
  h1->SetStats(kFALSE);
  ...
  TFile* file2 = TFile::Open("SVFitOptimization/Output_TTGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h2 = (TH2F*)file2->Get("h_HT_SVFitemuGamma_LowCutValue");
  h2->SetLineWidth(3);
  h2->SetLineColor(kRed);
  //h2->Draw("BOX SAME");

  TFile* file3 = new TFile("SVFitOptimization/Output_WGstarToLNu2Mu_TuneZ2star_CaloMET_All.root");
  TH2F *h3 = (TH2F*)file3->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file4 = new TFile("SVFitOptimization/Output_ZZJetsTo4L_TuneZ2star_CaloMET_All.root");
  TH2F *h4 = (TH2F*)file4->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file5 = new TFile("SVFitOptimization/Output_T_tW_CaloMET_All.root");
  TH2F *h5 = (TH2F*)file5->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file6 = new TFile("SVFitOptimization/Output_Tbar_tW_CaloMET_All.root");  
  TH2F *h6 = (TH2F*)file6->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file7 = new TFile("SVFitOptimization/Output_WZJetsTo3LNu_CaloMET_All.root");
  TH2F *h7 = (TH2F*)file7->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file8 = new TFile("SVFitOptimization/Output_WWGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h8 = (TH2F*)file8->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file9 = new TFile("SVFitOptimization/Output_SinglePhotonParked_Run2012D_22Jan2013_All.root");
  TH2F *h9 = (TH2F*)file9->Get("h_HT_SVFitemuGamma_LowCutValue");

  TFile* file10 = TFile::Open("SVFitOptimization/Output_Stop100_Chargino75_Neutralino30_Ntuple_Pta20_All.root");
  TH2F *h10 = (TH2F*)file10->Get("h_HT_SVFitemuGamma_LowCutValue");
  h10->SetLineWidth(3);
  h10->SetLineColor(kBlack);
  //h10->Draw("BOX SAME");
  ...
  h_Significance->Draw("COLZ TEXT");
  c1.SaveAs("h_Significance_h_HT_SVFitemuGamma_LowCutValue.pdf");
  c1.SaveAs("h_Significance_h_HT_SVFitemuGamma_LowCutValue.png");
  std::string histfilename=(outfile+".root").c_str();
  TFile *tFile=new TFile(histfilename.c_str(), "RECREATE");
  h1->Write("h_ZGToLLG");
  h2->Write("h_TTG");
...
void Optimization2D_h_HT_SVFitemu_LowCutValue(std::string outfile){
  ...
  TFile* file1 = TFile::Open("SVFitOptimization/Output_ZGToLLG_8TeV_CaloMET_All.root");
  TH2F *h1 = (TH2F*)file1->Get("h_HT_SVFitemu_LowCutValue");
  //h1->SetLineWidth(3);
  h1->SetLineColor(kBlue);
  h1->SetLineWidth(3);
  h1->SetStats(kFALSE);
  ...
  TFile* file2 = TFile::Open("SVFitOptimization/Output_TTGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h2 = (TH2F*)file2->Get("h_HT_SVFitemu_LowCutValue");
  h2->SetLineWidth(3);
  h2->SetLineColor(kRed);
  //h2->Draw("BOX SAME");

  TFile* file3 = new TFile("SVFitOptimization/Output_WGstarToLNu2Mu_TuneZ2star_CaloMET_All.root");
  TH2F *h3 = (TH2F*)file3->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file4 = new TFile("SVFitOptimization/Output_ZZJetsTo4L_TuneZ2star_CaloMET_All.root");
  TH2F *h4 = (TH2F*)file4->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file5 = new TFile("SVFitOptimization/Output_T_tW_CaloMET_All.root");
  TH2F *h5 = (TH2F*)file5->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file6 = new TFile("SVFitOptimization/Output_Tbar_tW_CaloMET_All.root");  
  TH2F *h6 = (TH2F*)file6->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file7 = new TFile("SVFitOptimization/Output_WZJetsTo3LNu_CaloMET_All.root");
  TH2F *h7 = (TH2F*)file7->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file8 = new TFile("SVFitOptimization/Output_WWGJets_8TeV_madgraph_CaloMET_All.root");
  TH2F *h8 = (TH2F*)file8->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file9 = new TFile("SVFitOptimization/Output_SinglePhotonParked_Run2012D_22Jan2013_All.root");
  TH2F *h9 = (TH2F*)file9->Get("h_HT_SVFitemu_LowCutValue");

  TFile* file10 = TFile::Open("SVFitOptimization/Output_Stop100_Chargino75_Neutralino30_Ntuple_Pta20_All.root");
  TH2F *h10 = (TH2F*)file10->Get("h_HT_SVFitemu_LowCutValue");
  h10->SetLineWidth(3);
  h10->SetLineColor(kBlack);
  //h10->Draw("BOX SAME");
  ...
  h_Significance->Draw("COLZ TEXT");
  c1.SaveAs("h_Significance_h_HT_SVFitemu_LowCutValue.pdf");
  c1.SaveAs("h_Significance_h_HT_SVFitemu_LowCutValue.png");
  std::string histfilename=(outfile+".root").c_str();
  TFile *tFile=new TFile(histfilename.c_str(), "RECREATE");
  h1->Write("h_ZGToLLG");
  h2->Write("h_TTG");
