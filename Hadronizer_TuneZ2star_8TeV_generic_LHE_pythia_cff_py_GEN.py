...
# with command line options: Configuration/GenProduction/python/EightTeV/Hadronizer_TuneZ2star_8TeV_generic_LHE_pythia_cff.py --mc --eventcontent AODSIM --datatier AODSIM --conditions START53_V19::All --beamspot Realistic8TeVCollision --step GEN --filein file:PostProcessing/decay_Pythia_Wonshell_NEW.lhe --fileout file:GEN.root -n -1
