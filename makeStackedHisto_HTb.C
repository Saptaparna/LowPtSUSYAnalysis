...
TH1F *h0 = (TH1F*)file0->Get("h_HTb_MuMu");
h0->Rebin(20);
...
TH1F *h1a = (TH1F*)file1a->Get("h_HTb_MuMu");
h1a->Rebin(20);
h1a->GetXaxis()->SetRangeUser(0, 500);
...
TH1F *h2 = (TH1F*)file2->Get("h_HTb_MuMu");
h2->Rebin(20);
...
TH1F *h3 = (TH1F*)file3->Get("h_HTb_MuMu");
h3->Rebin(20);
...
TH1F *h4 = (TH1F*)file4->Get("h_HTb_MuMu");
h4->Rebin(20);
...
TH1F *h5 = (TH1F*)file5->Get("h_HTb_MuMu");
h5->Rebin(20);
...
TH1F *h_Data = (TH1F*)file_Data->Get("h_HTb_MuMu");
h_Data->Rebin(20);
h_Data->SetLineColor(kBlack);
h_Data->SetMarkerStyle(20);
h_Data->SetMarkerSize(1.0);
h_Data->GetXaxis()->SetRangeUser(150, 500);
h_Data->Draw("SAME E");

TFile* file_Signal = TFile::Open("Signal/Output_LowPtSUSY_Tree_Stop100_Chargino75_Neutralino30_Ntuple_Pta20.root");
TH1F *h_Signal = (TH1F*)file_Signal->Get("h_HTb_MuMu");
h_Signal->Rebin(20);
h_Signal->GetXaxis()->SetRangeUser(0, 500);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_HTb_MuMu");
h_Signal_Stop->Rebin(20);
h_Signal_Stop->GetXaxis()->SetRangeUser(0, 500);
...
c1.SaveAs("h_HTb_MuMu_Stacked.pdf");
c1.SaveAs("h_HTb_MuMu_Stacked.png");
}
