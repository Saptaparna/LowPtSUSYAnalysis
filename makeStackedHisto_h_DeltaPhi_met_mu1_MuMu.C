...
THStack hs("hs","#Delta#phi(MET, leading muon)");
...
TH1F *hSS = (TH1F*)fileSS->Get("h_DeltaPhi_met_mu1_MuMu");
hSS->Rebin(100);
...
TH1F *h_Signal_Stop = (TH1F*)file_Signal->Get("h_DeltaPhi_met_mu1_MuMu");
...
h_ratio->SetTitle("; #bf{#Delta#phi(MET, leading muon)}; Data/MC Ratio");
