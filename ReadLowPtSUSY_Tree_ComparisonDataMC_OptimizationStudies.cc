#include "ReadLowPtSUSY_Tree_ComparisonDataMC_OptimizationStudies.h"

int ReadLowPtSUSY_Tree_ComparisonDataMC_OptimizationStudies(std::string infile, std::string outfile, std::string type, std::string signSelection, std::string MCSample){
