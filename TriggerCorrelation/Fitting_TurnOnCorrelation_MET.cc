...
void Fitting_TurnOnCorrelation(std::string infile, std::string outfile){
  ...
  Double_t rebin_array_1_Y[7]={0.0,  20.0, 40.0, 80.0, 100.0, 200.0, 600.0};
  TH2F *h_ControlTrigger1_Rebin = new TH2F("h_ControlTrigger1_Rebin",h_ControlTrigger_1->GetTitle(), 6, rebin_array_1_X, 6, rebin_array_1_Y);
  ...
  TH2F *h_AnalysisTrigger1_Rebin = new TH2F("h_AnalysisTrigger1_Rebin",h_AnalysisTrigger_1->GetTitle(), 6, rebin_array_1_X, 6, rebin_array_1_Y);
  ...
  TH2F *h_ControlTrigger1_RemoveJets_Rebin = new TH2F("h_ControlTrigger1_RemoveJets_Rebin",h_ControlTrigger_1_RemoveJets->GetTitle(), 6, rebin_array_1_X, 6, rebin_array_1_Y);
  ...
  TH2F *h_AnalysisTrigger1_RemoveJets_Rebin = new TH2F("h_AnalysisTrigger1_RemoveJets_Rebin",h_AnalysisTrigger_1_RemoveJets->GetTitle(), 6, rebin_array_1_X, 6, rebin_array_1_Y);
  ...
  TH2F *h_Eff1_2D = new TH2F("h_Eff1_2D", "Efficiency 1: Analysis Trigger versus Control Trigger", 6, rebin_array_1_X, 6, rebin_array_1_Y); 
  ...
  TH2F *h_Eff1_2D_RemoveJets = new TH2F("h_Eff1_2D_RemoveJets", "Efficiency 1: Analysis Trigger versus Control Trigger", 6, rebin_array_1_X, 6, rebin_array_1_Y);
