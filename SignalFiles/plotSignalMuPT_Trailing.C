...
void plotSignalMuPT_Trailing(){

  gROOT->SetStyle("Plain");

  TCanvas c1("c1","Signal Leading Muon pT",10,10,600,400);
  ...
  h4->Rebin(2);
  h4->GetXaxis()->SetRangeUser(0, 100);
  ...
  h5->Rebin(2);
  h5->GetXaxis()->SetRangeUser(0, 100);
  ...
  c1.SaveAs("MuonPt_Trailing_Delphes.pdf");
  c1.SaveAs("MuonPt_Trailing_Delphes.png");
