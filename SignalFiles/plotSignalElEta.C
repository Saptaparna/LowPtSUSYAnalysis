...
void plotSignalElEta(){
  ...
  TH1F *h1 = (TH1F*)file1->Get("h_el_eta_leading");
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_el_eta_leading");
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_el_eta_leading");
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_el_eta_leading");
  ...
  TH1F *h5 = (TH1F*)file5->Get("h_el_eta_leading");
  ...
  TH1F *h6 = (TH1F*)file6->Get("h_el_eta_leading");
  ...
  c1.SaveAs("ElectronEta_Delphes.pdf");
  c1.SaveAs("ElectronEta_Delphes.png");
