...
void plotSignalJetPT(){

  gROOT->SetStyle("Plain");

  TCanvas c1("c1","Signal Leading Jet pT",10,10,600,400);

  c1.SetLogy();

  TFile* file1 = TFile::Open("Output_LowPtSUSY_Tree_M1200_M2200_Delphes.root");
  TH1F *h1 = (TH1F*)file1->Get("h_jet_pt_leading");
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_jet_pt_leading");
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_jet_pt_leading");
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_jet_pt_leading");
  ...
  TH1F *h5 = (TH1F*)file5->Get("h_jet_pt_leading");
  ...
  TH1F *h6 = (TH1F*)file6->Get("h_jet_pt_leading");
  ...
  c1.SaveAs("JetPt_Delphes.pdf");
  c1.SaveAs("JetPt_Delphes.png");
